...
Berdasarkan hasil output diatas, dapat dilihat bahwa :

Pendugaan parameter Indeks Pembangunan Manusia (IPM) yaitu :

$$
\hat{\mathrm{Y}}=3.553+0.4669 \mathrm{AHH}+0.8109 \mathrm{HLS}+1.041 \mathrm{RLS}+0.001544 \mathrm{PRPK}+(-0,0001156 \mathrm{PDRB})
$$
...
<https://rpubs.com/Raissaloretta/ARGBRG16> 
<http://bit.ly/3GGyVfA>
